CREATE EXTERNAL TABLE [DELTA].[ICONI_vBIRestart_VacancyInterest]
(
...
WITH (DATA_SOURCE = [ADLG2_PSA],LOCATION = N'delta/ICONI/vBIRestart_VacancyInterest/IsCurrent=true',FILE_FORMAT = [parquet_file_format],REJECT_TYPE = VALUE,REJECT_VALUE = 0)
GO