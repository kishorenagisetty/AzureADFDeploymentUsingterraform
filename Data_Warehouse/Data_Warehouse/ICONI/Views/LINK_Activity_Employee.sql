CREATE VIEW [ICONI].[LINK_Activity_Employee]
AS 
-- ===============================================================
-- Author:	Shaz Rehman
-- Create date: 23/11/2023
-- Ticket Ref: #30197
-- Name: [ICONI].[LINK_Activity_Employee]
-- Description: Runs the Link Activity Employee Type Data
-- Revisions:
...
ON M.meet_advisor_user_id = E.[user_id]
AND M.IsCurrent = 1
AND E.IsCurrent = 1
-- 30197 - SR - 23/11/2023
UNION
